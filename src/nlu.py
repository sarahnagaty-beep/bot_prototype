...
SYNONYMS: dict[str, list[str]] = {
    ...
    "cairo_east": ["cairo east", "east cairo", "east", "new cairo side", "tagamoa side"],
    "cairo_west": ["cairo west", "west cairo", "west", "zayed side", "october side", "giza side"],
    "new_cairo": ["new cairo", "newcairo", "tagamoa", "tagamo3", "fifth settlement"],
    "mostakbal_city": ["mostakbal", "mostakbal city", "el mostakbal", "future city"],
    "new_capital": ["new capital", "capital", "administrative capital", "asema"],
    "madinaty": ["madinaty", "madinati"],
    "zayed_north": ["zayed north", "north zayed", "sheikh zayed north"],
    "sidi_abdel_rahman": ["sidi abdel rahman", "sidi abdelrahman", "sidi"],
    "ras_el_hekma": ["ras el hekma", "ras elhekma", "hekma", "ras al hekma"],
    "alamein": ["alamein", "el alamein", "new alamein"],
    "any": ["anywhere", "any", "no preference", "open", "all of it", "doesnt matter", "doesn't matter"],
    "sheikh_zayed": ["sheikh zayed", "zayed", "el sheikh zayed"],
    "north_coast": ["north coast", "sahel", "el sahel", "coast", "beach", "summer"],
